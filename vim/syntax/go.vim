...
hi def link     goDeclaration       Typedef
...
" syn match goCustomType        /\<T_[_a-zA-Z0-9]*\>/

hi def link     goType              Type
" hi def link     goCustomType        Typedef
...
syn match       goFunctionParen "("
syn match       goFunction          /[^a-zA-z0-9_]\<[a-zA-Z0-9_]\+\>(/ contains=goFunctionParen,goCustomType
...
" Regions
syn region      goBlock             start="{" end="}" transparent fold keepend extend
...
hi def link     goTagTypes Type
hi def link     goTagFunctions Function
